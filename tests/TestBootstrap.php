 ...
 * PSR-4-Loader für `Ruhrcoder\\RcCartSharing\\` als Fallback ein.
 *
...
spl_autoload_register(static function (string $class): void {
    $prefixes = [
        'Ruhrcoder\\RcCartSharing\\Tests\\' => __DIR__ . '/',
        'Ruhrcoder\\RcCartSharing\\' => dirname(__DIR__) . '/src/',
    ];
 ...
 * „Could not find plugin: RcCartSharing" — noch bevor ein einziger
 * Unit-Test läuft.
 *
